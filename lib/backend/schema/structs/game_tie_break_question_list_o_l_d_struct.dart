...
class GameTieBreakQuestionListOLDStruct extends FFFirebaseStruct {
  GameTieBreakQuestionListOLDStruct({
    DateTime? createdAt,
    DateTime? updatedAt,
    String? status,
    int? roundID,
  ...
  static GameTieBreakQuestionListOLDStruct fromMap(Map<String, dynamic> data) =>
      GameTieBreakQuestionListOLDStruct(
  ...
  static GameTieBreakQuestionListOLDStruct? maybeFromMap(dynamic data) => data
          is Map
      ? GameTieBreakQuestionListOLDStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static GameTieBreakQuestionListOLDStruct fromSerializableMap(
  ...
  @override
  String toString() => 'GameTieBreakQuestionListOLDStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is GameTieBreakQuestionListOLDStruct &&
...
GameTieBreakQuestionListOLDStruct createGameTieBreakQuestionListOLDStruct({
  DateTime? createdAt,
  DateTime? updatedAt,
  String? status,
  int? roundID,
...
GameTieBreakQuestionListOLDStruct? updateGameTieBreakQuestionListOLDStruct(
  GameTieBreakQuestionListOLDStruct? gameTieBreakQuestionListOLD, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    gameTieBreakQuestionListOLD
      ?..firestoreUtilData = FirestoreUtilData(
        clearUnsetFields: clearUnsetFields,
        create: create,
      );

void addGameTieBreakQuestionListOLDStructData(
  ...
  if (gameTieBreakQuestionListOLD == null) {
    return;
  }
  if (gameTieBreakQuestionListOLD.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields = !forFieldValue &&
      gameTieBreakQuestionListOLD.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final gameTieBreakQuestionListOLDData =
      getGameTieBreakQuestionListOLDFirestoreData(
          gameTieBreakQuestionListOLD, forFieldValue);
  final nestedData = gameTieBreakQuestionListOLDData
      .map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields =
      gameTieBreakQuestionListOLD.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getGameTieBreakQuestionListOLDFirestoreData(
  GameTieBreakQuestionListOLDStruct? gameTieBreakQuestionListOLD, [
  bool forFieldValue = false,
]) {
  if (gameTieBreakQuestionListOLD == null) {
  ...
  final firestoreData = mapToFirestore(gameTieBreakQuestionListOLD.toMap());

  // Handle nested data for "selectedQuestionList" field.
  addSelectedQuestionListStructData(
    firestoreData,
    gameTieBreakQuestionListOLD.hasSelectedQuestionList()
        ? gameTieBreakQuestionListOLD.selectedQuestionList
        : null,
    'selectedQuestionList',
    forFieldValue,
  );
  ...
  mapToFirestore(gameTieBreakQuestionListOLD.firestoreUtilData.fieldValues)
      .forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getGameTieBreakQuestionListOLDListFirestoreData(
  List<GameTieBreakQuestionListOLDStruct>? gameTieBreakQuestionListOLDs,
) =>
    gameTieBreakQuestionListOLDs
        ?.map((e) => getGameTieBreakQuestionListOLDFirestoreData(e, true))
        .toList() ??
    [];
