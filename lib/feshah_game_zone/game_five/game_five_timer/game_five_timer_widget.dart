...
import 'game_five_timer_model.dart';
export 'game_five_timer_model.dart';

class GameFiveTimerWidget extends StatefulWidget {
  const GameFiveTimerWidget({
    super.key,
  ...
  @override
  State<GameFiveTimerWidget> createState() => _GameFiveTimerWidgetState();
}

class _GameFiveTimerWidgetState extends State<GameFiveTimerWidget> {
  late GameFiveTimerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameFiveTimerModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.instantTimer = InstantTimer.periodic(
        ...
        callback: (timer) async {
          if ((FFAppState().userflow.timmerStatus == 'set') ||
              (FFAppState().userflow.timmerStatus == null ||
                  FFAppState().userflow.timmerStatus == '')) {
