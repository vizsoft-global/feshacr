...
import 'game_four_user1_model.dart';
export 'game_four_user1_model.dart';

class GameFourUser1Widget extends StatefulWidget {
  const GameFourUser1Widget({
    super.key,
    this.teamInfo,
    bool? workStatus,
    this.selectedGameID,
  ...
  @override
  State<GameFourUser1Widget> createState() => _GameFourUser1WidgetState();
}

class _GameFourUser1WidgetState extends State<GameFourUser1Widget> {
  late GameFourUser1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameFourUser1Model());
