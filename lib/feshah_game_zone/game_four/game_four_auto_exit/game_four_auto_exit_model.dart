...
import 'dart:async';
import '/index.dart';
import 'game_four_auto_exit_widget.dart' show GameFourAutoExitWidget;
...
class GameFourAutoExitModel extends FlutterFlowModel<GameFourAutoExitWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in GameFour_AutoExit widget.
  RoomRecord? roomResultEntry;
  // Stores action output result for [Firestore Query - Query a collection] action in GameFour_AutoExit widget.
  IDmapRecord? idmapResultEntry;
  // Stores action output result for [Firestore Query - Query a collection] action in GameFour_AutoExit widget.
