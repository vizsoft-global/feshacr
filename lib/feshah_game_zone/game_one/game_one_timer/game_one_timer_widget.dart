...
import 'game_one_timer_model.dart';
export 'game_one_timer_model.dart';

class GameOneTimerWidget extends StatefulWidget {
  const GameOneTimerWidget({
    super.key,
  ...
  @override
  State<GameOneTimerWidget> createState() => _GameOneTimerWidgetState();
}

class _GameOneTimerWidgetState extends State<GameOneTimerWidget> {
  late GameOneTimerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameOneTimerModel());
