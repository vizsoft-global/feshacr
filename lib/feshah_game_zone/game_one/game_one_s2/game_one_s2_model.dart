...
import '/index.dart';
import 'game_one_s2_widget.dart' show GameOneS2Widget;
...
class GameOneS2Model extends FlutterFlowModel<GameOneS2Widget> {
  ...
  // Model for GameOne_Initial component.
  late GameOneInitialModel gameOneInitialModel;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  IDmapRecord? idmapResult;
  AudioPlayer? soundPlayer;
  // Stores action output result for [Firestore Query - Query a collection] action in Button widget.
  IDmapRecord? idmapResultNone;
  ...
  void initState(BuildContext context) {
    ...
    gameOneInitialModel = createModel(context, () => GameOneInitialModel());
