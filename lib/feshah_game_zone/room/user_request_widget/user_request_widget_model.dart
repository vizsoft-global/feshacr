...
import 'dart:async';
import 'dart:ui';
import 'user_request_widget_widget.dart' show UserRequestWidgetWidget;
...
class UserRequestWidgetModel extends FlutterFlowModel<UserRequestWidgetWidget> {
  ...
  // Stores action output result for [Backend Call - Read Document] action in Button widget.
  NotificationRecord? roomUserNotificationResult;
