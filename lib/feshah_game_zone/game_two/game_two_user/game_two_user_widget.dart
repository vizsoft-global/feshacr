...
import 'game_two_user_model.dart';
export 'game_two_user_model.dart';

class GameTwoUserWidget extends StatefulWidget {
  const GameTwoUserWidget({
    super.key,
  ...
  @override
  State<GameTwoUserWidget> createState() => _GameTwoUserWidgetState();
}

class _GameTwoUserWidgetState extends State<GameTwoUserWidget> {
  late GameTwoUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameTwoUserModel());
                  ...
                  children: [
                    ...
                    if (widget!.gameSAUvoteStatus == true)
                      Row(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          if (((widget!.room?.selectedGameList?.elementAtOrNull(
                                          widget!.selectedGameIndex!))
                                      ?.gameSAU
                                      ?.lastOrNull
                                      ?.voteUser
                                      ?.where((e) =>
                                          e.fromUserRef == currentUserReference)
                                      .toList()
                                      ?.length ==
                                  0) &&
                              (widget!.roomUser?.roomUserRef !=
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.gameSAU = widget!.room!.selectedGameList
                                    .elementAtOrNull(
                                        widget!.selectedGameIndex!)!
                                    .gameSAU
                                    .toList()
                                    .cast<GameSAUStruct>();
                                _model.indexSAU = widget!.room!.selectedGameList
                                        .elementAtOrNull(
                                            widget!.selectedGameIndex!)!
                                        .gameSAU
                                        .length -
                                ...
                                _model.updateSelectedGameListAtIndex(
                                  ...
                                  (e) => e
                                    ..updateGameSAU(
                                      (e) => e[_model.indexSAU!]
                                        ..updateVoteUser(
                                          (e) => e.add(GameSAUVoteUserStruct(
                                            voteCreatedAt: getCurrentTimestamp,
                                            voteUpdatedAt: getCurrentTimestamp,
                                            voteStatus: 'active',
                                            voteId: _model.idmapResult?.voteId,
                                            toUserRef:
                                                widget!.roomUser?.roomUserRef,
                                            ...
                                            fromUserUid: valueOrDefault(
                                                    ...
                                                    0)
                                                .toString(),
                                            toUserUid: containerUsersRecord.uid,
                                          )),
                                        ),
                                    ),
                                );
                    ...
                    if (widget!.gameUserRemove == true)
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          if ((_model.notificationResultRemove != null) ==
                              true) {
                            unawaited(
                              () async {
                                await _model.notificationResultRemove!.reference
                                    .delete();
                              }(),
                            );
                          }
                          ...
                          while (_model.userCount! > 0) {
                            if (_model.userList
                                    .elementAtOrNull((_model.userCount!) - 1)
                                    ?.roomUserRef ==
                                widget!.user) {
                      ...
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          ...
                          while (_model.userCount! > 0) {
                            if ((_model.selectedGameList
                              ...
                              if (_model.userList
                                ...
                                if (_model.notificationResultNew! > 0) {
                                  unawaited(
                                    () async {
                                      await showDialog(
                                        context: context,
                          ...
                          if (_model.userFoundStatus == 'notFound') {
                            await showDialog(
                              ...
                              builder: (alertDialogContext) {
                                return WebViewAware(
                                  child: AlertDialog(
                                    content: Text('Already added in game.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                          ...
                          if ((_model.userFoundStatus == 'found') &&
                              ((widget!.room?.selectedGameList?.elementAtOrNull(
                                          widget!.selectedGameIndex!))
                            ...
                            await NotificationRecord.collection
                                ...
                                .set(createNotificationRecordData(
                                  ...
                                  notificationID: _model
                                      .idmapNotificationResult2?.notificationId,
                                  notificationStatus: 'send',
                                  toUserRef: widget!.roomUser?.roomUserRef,
                                  fromUserRef: currentUserReference,
                                  ...
                                  gameInfo: updateGameInfoStruct(
                                    GameInfoStruct(
                                      ...
                                      gameID: _model.gameResult?.gameID,
                                      gameInfo: _model.gameResult?.gameInfo,
                            ...
                            await _model.idmapNotificationResult2!.reference
                                .update({
                              ...mapToFirestore(
                                {
