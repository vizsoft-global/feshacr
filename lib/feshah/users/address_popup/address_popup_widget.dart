...
import 'address_popup_model.dart';
export 'address_popup_model.dart';

class AddressPopupWidget extends StatefulWidget {
  const AddressPopupWidget({super.key});

  @override
  State<AddressPopupWidget> createState() => _AddressPopupWidgetState();
}

class _AddressPopupWidgetState extends State<AddressPopupWidget> {
  late AddressPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddressPopupModel());

    _model.streetTextController ??=
        TextEditingController(text: currentUserDocument?.userAddress?.street1);
    _model.streetFocusNode ??= FocusNode();

    _model.buildingTextController ??= TextEditingController(
        text: currentUserDocument?.userAddress?.flatNumber);
    _model.buildingFocusNode ??= FocusNode();

    _model.areaTextController ??=
        TextEditingController(text: currentUserDocument?.userAddress?.street2);
    _model.areaFocusNode ??= FocusNode();

    _model.cityTextController ??=
        TextEditingController(text: currentUserDocument?.userAddress?.city);
    _model.cityFocusNode ??= FocusNode();

    _model.countryTextController ??=
        TextEditingController(text: currentUserDocument?.userAddress?.country);
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await currentUserReference!
                                    ...
                                    userAddress: createUserAddressStruct(
                                      flatNumber:
                                          _model.buildingTextController.text,
                                      street1: _model.streetTextController.text,
                                      street2: _model.areaTextController.text,
