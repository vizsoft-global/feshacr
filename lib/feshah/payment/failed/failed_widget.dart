...
class FailedWidget extends StatefulWidget {
  ...
  static String routeName = 'Failed';
  static String routePath = '/failed';
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Lottie.asset(
                                      'assets/jsons/unsuccessfull-purchase.json',
                                      width: 96.0,
                                      height: 96.0,
                                      fit: BoxFit.contain,
                                      animate: true,
                                    ...
                                    Text(
                                      FFLocalizations.of(context).getText(
                                        'bj59d9cr' /* Your Purchase was unsuccessful */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
