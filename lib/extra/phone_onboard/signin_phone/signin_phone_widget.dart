...
import 'signin_phone_model.dart';
export 'signin_phone_model.dart';

class SigninPhoneWidget extends StatefulWidget {
  const SigninPhoneWidget({super.key});

  static String routeName = 'Signin-phone';
  static String routePath = '/login-phone';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'q5kofnpf' /* Access your account to enjoy a... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
